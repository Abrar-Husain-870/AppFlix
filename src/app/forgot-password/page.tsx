...
import { Loader2, CheckCircle, Globe, ArrowLeft, LogIn } from 'lucide-react'
        ...
        <div style={{
          ...
          {state?.message ? (
            ...
            <div style={{ textAlign: 'center' }}>
              ...
              <p style={{ color: '#CCCCCC', fontSize: '0.95rem', lineHeight: 1.6, marginBottom: '1.75rem' }}>
                {state.message}
              </p>
            ...
            <>
              ...
              <p style={{
                ...
                Enter the email address associated with your AppFlix account, and we'll send you a password reset link.
              </p>
              ...
              <div style={{
                ...
                <span style={{ color: '#888888', fontSize: '0.78rem', fontWeight: 600 }}>REMEMBERED YOUR PASSWORD?</span>
                <div style={{ flex: 1, height: '1px', background: 'rgba(255, 255, 255, 0.15)' }} />
              </div>
